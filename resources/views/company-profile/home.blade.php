@extends('layouts.company-profile', ['title' => 'Black Diamond Swimming Club - Klub Renang Profesional'])
...
@section('content')
    ...
    <section class="relative -mt-12 max-w-5xl mx-auto px-4 z-20">
        <div
            ...
            <div class="space-y-1">
                <p class="text-4xl font-extrabold text-blue-600">{{ $totalCoaches }}+</p>
            ...
            <div class="space-y-1 border-y md:border-y-0 md:border-x border-slate-100 py-6 md:py-0">
                <p class="text-4xl font-extrabold text-blue-600">{{ $totalLocations }}+</p>
