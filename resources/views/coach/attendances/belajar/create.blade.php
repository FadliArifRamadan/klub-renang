<x-app-layout title="Coach - Input Absensi Kelas Belajar">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Input Absensi Murid (Kelas Belajar)') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('coach.attendances.belajar.store') }}" method="POST">
                    @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr id="empty-state-row" style="display: none;">
                                        <td colspan="6" class="px-6 py-12 text-center text-gray-500 bg-gray-50/50">
                                            ...
                                            <p class="font-medium text-gray-600">Tidak ada jadwal murid pada tanggal ini.</p>
                                            <p class="text-xs mt-1 text-gray-400">Silakan pilih tanggal yang lain.</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
