                        ...
                        <tbody>
                            @forelse($schedules as $index => $sched)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-gray-900 font-semibold">{{ $sched->swimmingClass->name }}</div>
                                        <div class="text-xs text-gray-500">{{ $sched->swimmingClass->category->name }}</div>
                                    </td>
                                        ...
                                        <x-modal name="confirm-schedule-deletion-{{ $sched->id }}" focusable>
                                            <form method="post" action="{{ route('admin.schedules.destroy', $sched->id) }}" class="p-6 text-left">
                                                ...
                                                <p class="text-sm text-gray-600">
                                                    Jadwal latihan <span class="font-bold text-gray-900">"{{ $sched->day_name }} {{ $sched->time_range }} di {{ $sched->location->name }}"</span>
