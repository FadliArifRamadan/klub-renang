            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100 dark:bg-boxdark dark:border-strokedark">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
                    ...
                    <form action="{{ route('admin.attendances.index') }}" method="GET" class="flex items-center gap-2 flex-nowrap whitespace-nowrap">
                        ...
                        <a href="{{ route('admin.attendances.index') }}" class="px-3.5 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-semibold rounded-lg transition-all shadow-sm flex items-center gap-1.5 whitespace-nowrap cursor-pointer shrink-0">
