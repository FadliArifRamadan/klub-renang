            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100 dark:bg-boxdark dark:border-strokedark">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
                    <h3 class="text-base font-semibold text-gray-800 dark:text-white">
                        <i class="fa-solid fa-clipboard-list text-amber-500 mr-2"></i>Riwayat Absensi Seluruh Coach
                    </h3>

                    {{-- Search Form --}}
                    <form action="{{ route('admin.attendances.index') }}" method="GET" class="flex items-center gap-2 flex-nowrap whitespace-nowrap">
                        ...
                        <a href="{{ route('admin.attendances.index') }}" class="px-3.5 py-2 bg-slate-700 hover:bg-slate-600 text-white text-xs font-bold rounded-lg border border-slate-600 shadow-sm transition flex items-center gap-1.5 whitespace-nowrap cursor-pointer shrink-0">
