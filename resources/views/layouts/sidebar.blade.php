        ...
        <a href="{{ route('login') }}">
            <template x-if="sidebarExpanded || sidebarHovered || mobileSidebarOpen">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('images/black_diamond_1.png') }}" alt="Logo" class="drop-shadow-[0_0_8px_rgba(211,175,55,0.4)]">
                </div>
            </template>
            <template x-if="!sidebarExpanded && !sidebarHovered && !mobileSidebarOpen">
                <img src="{{ asset('images/black_diamond.png') }}" alt="Logo" class="w-10 mx-auto drop-shadow-[0_0_8px_rgba(211,175,55,0.4)]">
            </template>
        </a>
    </div>
                                    ...
                                    <ul x-show="open" x-transition class="mt-2 space-y-1" style="display: none;">
                                        <li>
                                            <a href="{{ route('coach.attendances.belajar.index') }}"
                                                class="block py-2 pl-12 pr-4 text-sm rounded-lg transition-colors {{ request()->routeIs('coach.attendances.belajar.*') ? 'bg-[#101828] text-[#D3AF37] font-black border border-[#F5E6A3]/30 shadow-md' : 'text-[#101828] hover:text-black hover:bg-[#101828]/15 font-bold' }}">
                                                Kelas Belajar
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('coach.attendances.prestasi.index') }}"
                                                class="block py-2 pl-12 pr-4 text-sm rounded-lg transition-colors {{ request()->routeIs('coach.attendances.prestasi.*') ? 'bg-[#101828] text-[#D3AF37] font-black border border-[#F5E6A3]/30 shadow-md' : 'text-[#101828] hover:text-black hover:bg-[#101828]/15 font-bold' }}">
                                                Kelas Prestasi
                                            </a>
                                        </li>
                                    </ul>
