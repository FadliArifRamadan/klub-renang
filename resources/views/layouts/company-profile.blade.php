        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-6">
                    ...
                    <a href="{{ route('about') }}"
                        class="text-sm font-bold transition-colors {{ request()->routeIs('about') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">Tentang
                        Kami</a>
                    <a href="{{ route('packages') }}"
                        class="text-sm font-bold transition-colors {{ request()->routeIs('packages') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">Program
                        Paket</a>
                    ...
                    <a href="{{ route('schedule') }}"
                        class="text-sm font-bold transition-colors {{ request()->routeIs('schedule') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">Jadwal
                        Latihan</a>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-250"
            ...
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <a @click="mobileMenuOpen = false" href="{{ route('about') }}"
                    class="block px-4 py-3 text-base font-bold rounded-xl {{ request()->routeIs('about') ? 'bg-[#101828] text-[#D3AF37]' : 'text-[#101828] hover:bg-black/10' }}">Tentang
                    Kami</a>
                <a @click="mobileMenuOpen = false" href="{{ route('packages') }}"
                    class="block px-4 py-3 text-base font-bold rounded-xl {{ request()->routeIs('packages') ? 'bg-[#101828] text-[#D3AF37]' : 'text-[#101828] hover:bg-black/10' }}">Program
                    Paket</a>
                ...
                <a @click="mobileMenuOpen = false" href="{{ route('schedule') }}"
                    class="block px-4 py-3 text-base font-bold rounded-xl {{ request()->routeIs('schedule') ? 'bg-[#101828] text-[#D3AF37]' : 'text-[#101828] hover:bg-black/10' }}">Jadwal
                    Latihan</a>
