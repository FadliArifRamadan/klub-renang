        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-6">
                    ...
                    <a href="{{ route('about') }}"
                        class="text-sm font-semibold transition-colors {{ request()->routeIs('about') ? 'text-blue-600' : 'text-slate-650 hover:text-blue-600' }}">Tentang
                        Kami</a>
                    <a href="{{ route('packages') }}"
                        class="text-sm font-semibold transition-colors {{ request()->routeIs('packages') ? 'text-blue-600' : 'text-slate-650 hover:text-blue-600' }}">Program
                        Paket</a>
                    <a href="{{ route('locations') }}"
                        class="text-sm font-semibold transition-colors {{ request()->routeIs('locations') ? 'text-blue-600' : 'text-slate-650 hover:text-blue-600' }}">Kolam
                        Latihan</a>
                    <a href="{{ route('schedule') }}"
                        class="text-sm font-semibold transition-colors {{ request()->routeIs('schedule') ? 'text-blue-600' : 'text-slate-650 hover:text-blue-600' }}">Jadwal
                        Latihan</a>
                    <a href="{{ route('contact') }}"
                        class="text-sm font-semibold transition-colors {{ request()->routeIs('contact') ? 'text-blue-600' : 'text-slate-650 hover:text-blue-600' }}">Kontak
                        Kami</a>
                </nav>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-250"
            ...
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <a @click="mobileMenuOpen = false" href="{{ route('about') }}"
                    class="block px-4 py-3 text-base font-semibold rounded-xl {{ request()->routeIs('about') ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-600' }}">Tentang
                    Kami</a>
                <a @click="mobileMenuOpen = false" href="{{ route('packages') }}"
                    class="block px-4 py-3 text-base font-semibold rounded-xl {{ request()->routeIs('packages') ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-600' }}">Program
                    Paket</a>
                <a @click="mobileMenuOpen = false" href="{{ route('locations') }}"
                    class="block px-4 py-3 text-base font-semibold rounded-xl {{ request()->routeIs('locations') ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-600' }}">Kolam
                    Latihan</a>
                <a @click="mobileMenuOpen = false" href="{{ route('schedule') }}"
                    class="block px-4 py-3 text-base font-semibold rounded-xl {{ request()->routeIs('schedule') ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-600' }}">Jadwal
                    Latihan</a>
                <a @click="mobileMenuOpen = false" href="{{ route('contact') }}"
                    class="block px-4 py-3 text-base font-semibold rounded-xl {{ request()->routeIs('contact') ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-600' }}">Kontak
                    Kami</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-sm text-slate-300">
                    ...
                    <li><a href="{{ route('about') }}" class="hover:text-blue-400 transition-colors">Tentang Kami</a>
                    </li>
                    <li><a href="{{ route('packages') }}" class="hover:text-blue-400 transition-colors">Program
                            Paket</a></li>
                    <li><a href="{{ route('locations') }}" class="hover:text-blue-400 transition-colors">Kolam
                            Latihan</a></li>
                    <li><a href="{{ route('schedule') }}" class="hover:text-blue-400 transition-colors">Jadwal
                            Latihan</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-blue-400 transition-colors">Kontak
                            Kami</a></li>
                </ul>
            </div>
