...
<body class="antialiased bg-slate-50 text-slate-800 overflow-x-hidden" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-6">
                    ...
                    <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative">
                        <button type="button"
                            class="flex items-center gap-1.5 text-sm font-bold transition-colors py-2 {{ request()->routeIs('about*') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            class="absolute left-0 top-full pt-2 w-60 z-50" style="display: none;">
                            <div
                                class="bg-[#101828] border border-[#D3AF37]/40 shadow-2xl rounded-2xl p-2 text-white overflow-hidden">
                                <a href="{{ route('about.vision-mission') }}"
                                    ...
                                    <i
                                        class="fa-solid fa-bullseye text-[#D3AF37] w-5 text-center {{ request()->routeIs('about.vision-mission') ? 'text-[#101828]' : '' }}"></i>
                                    <span>Visi & Misi</span>
                                </a>
                                <a href="{{ route('about.history') }}"
                                    ...
                                    <i
                                        class="fa-solid fa-timeline text-[#D3AF37] w-5 text-center {{ request()->routeIs('about.history') ? 'text-[#101828]' : '' }}"></i>
                                ...
                                <a href="{{ route('about.coaches') }}"
                                    ...
                                    <i
                                        class="fa-solid fa-user-tie text-[#D3AF37] w-5 text-center {{ request()->routeIs('about.coaches') ? 'text-[#101828]' : '' }}"></i>
                                    <span>Tim Instruktur</span>
                                </a>
                                <a href="{{ route('about.founders') }}"
                                    class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-bold transition-colors {{ request()->routeIs('about.founders') ? 'bg-[#D3AF37] text-[#101828]' : 'text-slate-200 hover:bg-[#D3AF37]/20 hover:text-[#D3AF37]' }}">
                                    <i
                                        class="fa-solid fa-crown text-[#D3AF37] w-5 text-center {{ request()->routeIs('about.founders') ? 'text-[#101828]' : '' }}"></i>
                                    <span>Founders</span>
                                </a>
                            </div>
                        </div>
                    ...
                    <div x-data="{ open: false, subOpen: false }" @mouseenter="open = true" @mouseleave="open = false; subOpen = false"
                        class="relative">
                        <button type="button"
                            class="flex items-center gap-1.5 text-sm font-bold transition-colors py-2 {{ request()->routeIs('packages*') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            x-transition:leave-start="opacity-100 translate-y-0"
                            x-transition:leave-end="opacity-0 translate-y-2"
                            class="absolute left-0 top-full pt-2 w-64 z-50" style="display: none;">
                            <div
                                class="bg-[#101828] border border-[#D3AF37]/40 shadow-2xl rounded-2xl p-2 text-white relative">
                                <!-- Nested Submenu Trigger for Kelas Belajar -->
                                <div class="relative" @mouseenter="subOpen = true" @mouseleave="subOpen = false">
                                    <div
                                        class="flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-bold transition-colors cursor-pointer {{ request()->routeIs('packages.belajar*') ? 'bg-[#D3AF37]/20 text-[#D3AF37]' : 'text-slate-200 hover:bg-[#D3AF37]/20 hover:text-[#D3AF37]' }}">
                                        <div class="flex items-center gap-3">
                                    ...
                                    <div x-show="subOpen" x-transition:enter="transition ease-out duration-150"
                                        ...
                                        class="absolute left-full top-0 pl-2 w-56 z-50" style="display: none;">
                                        <div
                                            class="bg-[#101828] border border-[#D3AF37]/40 shadow-2xl rounded-2xl p-2 text-white space-y-1">
                                            <a href="{{ route('packages.belajar.level', 'batita') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-baby text-[#D3AF37] w-4 text-center {{ request()->is('program-paket/belajar/batita') ? 'text-[#101828]' : '' }}"></i>
                                            ...
                                            <a href="{{ route('packages.belajar.level', 'balita') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-child text-[#D3AF37] w-4 text-center {{ request()->is('program-paket/belajar/balita') ? 'text-[#101828]' : '' }}"></i>
                                            ...
                                            <a href="{{ route('packages.belajar.level', 'anak-anak') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-child-reaching text-[#D3AF37] w-4 text-center {{ request()->is('program-paket/belajar/anak-anak') ? 'text-[#101828]' : '' }}"></i>
                                            ...
                                            <a href="{{ route('packages.belajar.level', 'dewasa') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-user text-[#D3AF37] w-4 text-center {{ request()->is('program-paket/belajar/dewasa') ? 'text-[#101828]' : '' }}"></i>
                                ...
                                <a href="{{ route('packages.prestasi') }}"
                                    ...
                                    <i
                                        class="fa-solid fa-trophy text-[#D3AF37] w-5 text-center {{ request()->routeIs('packages.prestasi') ? 'text-[#101828]' : '' }}"></i>
                    ...
                    <div x-data="{ open: false, subOpen: false }" @mouseenter="open = true"
                        @mouseleave="open = false; subOpen = false" class="relative">
                        <button type="button"
                            class="flex items-center gap-1.5 text-sm font-bold transition-colors py-2 {{ request()->routeIs('schedule*') ? 'text-[#101828] underline underline-offset-4 decoration-2 font-extrabold' : 'text-[#101828]/80 hover:text-[#101828]' }}">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div
                                ...
                                <div class="relative" @mouseenter="subOpen = true" @mouseleave="subOpen = false">
                                    <div
                                        class="flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-bold transition-colors cursor-pointer {{ request()->routeIs('schedule.belajar*') ? 'bg-[#D3AF37]/20 text-[#D3AF37]' : 'text-slate-200 hover:bg-[#D3AF37]/20 hover:text-[#D3AF37]' }}">
                                        <div class="flex items-center gap-3">
                                            <i class="fa-solid fa-person-swimming text-[#D3AF37] w-5 text-center"></i>
                                            <span>Kelas Belajar Renang</span>
                                        </div>
                                    ...
                                    <div x-show="subOpen" x-transition:enter="transition ease-out duration-150"
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('schedule.belajar.level', 'batita') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-baby text-[#D3AF37] w-4 text-center {{ request()->is('jadwal-latihan/belajar/batita') ? 'text-[#101828]' : '' }}"></i>
                                                <span>Tingkat Batita (1-3 Thn)</span>
                                            </a>
                                            <a href="{{ route('schedule.belajar.level', 'balita') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-child text-[#D3AF37] w-4 text-center {{ request()->is('jadwal-latihan/belajar/balita') ? 'text-[#101828]' : '' }}"></i>
                                                <span>Tingkat Balita (4-5 Thn)</span>
                                            </a>
                                            <a href="{{ route('schedule.belajar.level', 'anak-anak') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-child-reaching text-[#D3AF37] w-4 text-center {{ request()->is('jadwal-latihan/belajar/anak-anak') ? 'text-[#101828]' : '' }}"></i>
                                                <span>Tingkat Anak (6-12 Thn)</span>
                                            </a>
                                            <a href="{{ route('schedule.belajar.level', 'dewasa') }}"
                                                ...
                                                <i
                                                    class="fa-solid fa-user text-[#D3AF37] w-4 text-center {{ request()->is('jadwal-latihan/belajar/dewasa') ? 'text-[#101828]' : '' }}"></i>
                                                <span>Tingkat Dewasa (13+ Thn)</span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <a href="{{ route('schedule.prestasi') }}"
                                    ...
                                    <i
                                        class="fa-solid fa-trophy text-[#D3AF37] w-5 text-center {{ request()->routeIs('schedule.prestasi') ? 'text-[#101828]' : '' }}"></i>
                                    <span>Kelas Renang Prestasi</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <div x-data="{ open: {{ request()->routeIs('about*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        class="w-full flex justify-between items-center px-4 py-3 text-base font-bold rounded-xl text-[#101828] hover:bg-black/10">
                        <span>Tentang Kami</span>
                        <i class="fa-solid fa-chevron-down text-xs transition-transform duration-200"
                            :class="{ 'rotate-180': open }"></i>
                    </button>
                    <div x-show="open" class="pl-4 pr-2 py-1 space-y-1">
                        ...
                        <a @click="mobileMenuOpen = false" href="{{ route('about.founders') }}"
                            class="block px-4 py-2.5 text-sm font-bold rounded-xl {{ request()->routeIs('about.founders') ? 'bg-[#101828] text-[#D3AF37]' : 'text-[#101828] hover:bg-black/10' }}">
                ...
                <div x-data="{ open: {{ request()->routeIs('packages*') ? 'true' : 'false' }}, subOpen: true }">
                    ...
                    <div x-show="open" class="pl-4 pr-2 py-1 space-y-1">
                        ...
                        <div class="space-y-1">
                            <div
                                class="flex items-center justify-between px-4 py-2.5 text-sm font-bold text-[#101828] rounded-xl hover:bg-black/10">
                            ...
                            <div x-show="subOpen" class="pl-6 space-y-1">
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('packages.belajar.level', 'batita') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('packages.belajar.level', 'balita') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('packages.belajar.level', 'anak-anak') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('packages.belajar.level', 'dewasa') }}"
                ...
                <div x-data="{ open: {{ request()->routeIs('schedule*') ? 'true' : 'false' }}, subOpen: true }">
                    ...
                    <div x-show="open" class="pl-4 pr-2 py-1 space-y-1">
                        ...
                        <div class="space-y-1">
                            ...
                            <div x-show="subOpen" class="pl-6 space-y-1">
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('schedule.belajar.level', 'batita') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('schedule.belajar.level', 'balita') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('schedule.belajar.level', 'anak-anak') }}"
                                ...
                                <a @click="mobileMenuOpen = false"
                                    href="{{ route('schedule.belajar.level', 'dewasa') }}"
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-sm text-[#101828]/90 font-bold">
                    <li><a href="{{ route('welcome') }}"
                            class="hover:text-black hover:underline transition-colors">Home</a></li>
                    <li><a href="{{ route('about') }}"
                            class="hover:text-black hover:underline transition-colors">Tentang Kami</a>
                    </li>
                    <li><a href="{{ route('packages') }}"
                            class="hover:text-black hover:underline transition-colors">Program
                            Paket</a></li>
                    <li><a href="{{ route('locations') }}"
                            class="hover:text-black hover:underline transition-colors">Kolam
                            Latihan</a></li>
                    <li><a href="{{ route('schedule') }}"
                            class="hover:text-black hover:underline transition-colors">Jadwal
                            Latihan</a></li>
                    <li><a href="{{ route('contact') }}"
                            class="hover:text-black hover:underline transition-colors">Kontak
                            Kami</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-sm text-[#101828]/90 font-bold">
                    <li class="flex items-center gap-2">
                        ...
                        <span>blackdiamondsupport5758@gmail.com</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-phone text-[#101828]"></i>
                        <span>+62 877-7157-5859</span>
                    </li>
                    <li class="flex items-center gap-2">
    ...
    <a class="float-wa"
        href="https://api.whatsapp.com/send/?phone=6287771575859&amp;text=Halo+Admin+Black+Diamond+Swimming+Club%2C+saya+ingin+tanya-tanya+mengenai+paket+dan+jadwal+latihan+renang.&amp;type=phone_number&amp;app_absent=0"
