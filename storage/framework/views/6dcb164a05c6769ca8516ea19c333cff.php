                ...
                <?php if(Auth::user()->isAdminOperasional()): ?>
                    <div>
                        ...
                        <ul class="flex flex-col gap-2">
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.founders.index')); ?>"
                                    class="menu-item group <?php echo e(request()->routeIs('admin.founders.*') ? 'menu-item-active' : 'menu-item-inactive'); ?>"
                                    :class="{
                                        'lg:justify-center': !sidebarExpanded && !
                                            sidebarHovered,
                                        'lg:justify-start': sidebarExpanded || sidebarHovered
                                    ...
                                    <span
                                        class="menu-item-icon-size <?php echo e(request()->routeIs('admin.founders.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'); ?>">
                                        <i class="fa-solid fa-crown text-xl w-6 text-center"></i>
                                    </span>
                                    <template x-if="sidebarExpanded || sidebarHovered || mobileSidebarOpen">
                                        <span class="menu-item-text">Kelola Founders</span>
                                    </template>
                                </a>
                            </li>
                        </ul>
