                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-400">Total: <?php echo e($student->package->sessions ?? 0); ?> Sesi</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo e($student->location->name ?? 'Belum Diplot'); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-400 mt-1">
                                            Sisa: <span class="font-semibold text-blue-600"><?php echo e($student->quota_left); ?> sesi</span>
                                        </div>
                                    </td>
