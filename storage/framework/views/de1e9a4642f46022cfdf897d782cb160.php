...
<?php $component = App\View\Components\AppLayout::resolve(['title' => 'Admin - Riwayat Absensi'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Riwayat Absensi (Semua Coach)')); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100 dark:bg-boxdark dark:border-strokedark">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
                    <h3 class="text-base font-semibold text-gray-800 dark:text-white">
                        <i class="fa-solid fa-clipboard-list text-blue-600 mr-2"></i>Riwayat Absensi Seluruh Coach
                    </h3>

                    
                    <form action="<?php echo e(route('admin.attendances.index')); ?>" method="GET" class="flex gap-2">
                        ...
                        <?php if(request('search')): ?>
                            <a href="<?php echo e(route('admin.attendances.index')); ?>" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg border border-gray-300 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-meta-4 dark:border-strokedark dark:text-white dark:hover:bg-gray-700 transition-colors">
                                Reset
                            </a>
                        <?php endif; ?>
                    </form>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\klub-renang\resources\views/admin/attendances/index.blade.php ENDPATH**/ ?>