                                ...
                                <div class="w-full">
                                    <div class="flex items-center justify-between">
                                        <span class="font-bold text-amber-400 text-sm">
                                            <i class="fa-solid fa-info-circle mr-1"></i> Informasi Sesi Diliburkan (<?php echo e($rq->student->name ?? 'Anak'); ?>)
                                        </span>
                                    ...
                                    <p class="mt-1 text-slate-300 text-xs leading-relaxed">
                                        Sesi latihan untuk <strong class="text-white"><?php echo e($rq->student->name ?? 'Anak'); ?></strong> pada hari <strong class="text-amber-300"><?php echo e(\Carbon\Carbon::parse($rq->original_date)->locale('id')->translatedFormat('l, d F Y')); ?></strong> (<?php echo e($rq->schedule->swimmingClass->name ?? ''); ?> — <?php echo e($rq->schedule->location->name ?? ''); ?>) <strong class="text-amber-300">diliburkan</strong> karena pelatih <strong class="text-white"><?php echo e($rq->coachLeave->coach->name ?? 'Pelatih'); ?></strong> berhalangan.
                                    </p>
                                ...
                                <div class="w-full">
                                    <div class="flex items-center justify-between">
                                        <span class="font-bold text-emerald-400 text-sm">
                                            <i class="fa-solid fa-circle-check mr-1"></i> Jadwal Pengganti (Reschedule) Ditetapkan! (<?php echo e($rq->student->name ?? 'Anak'); ?>)
                                        </span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name-'.e($expStudent->id).'','value' => 'Nama Lengkap Anak *']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'name-'.e($expStudent->id).'','value' => 'Nama Lengkap Anak *']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name-'.e($expStudent->id).'','class' => 'block mt-1 w-full text-sm','type' => 'text','name' => 'name','value' => ''.e($expStudent->name).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name-'.e($expStudent->id).'','class' => 'block mt-1 w-full text-sm','type' => 'text','name' => 'name','value' => ''.e($expStudent->name).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                ...
                                                <div class="mb-4">
                                                    <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['value' => 'Nomor HP / WhatsApp Orang Tua']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => 'Nomor HP / WhatsApp Orang Tua']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
