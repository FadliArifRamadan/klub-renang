                    ...
                    <div>
                        <div class="border-b border-slate-200 pb-4 mb-8 text-left">
                            <h2 class="text-2xl font-extrabold text-slate-800 flex items-center gap-2">
                                ...
                                Tingkat <?php echo e($class->name); ?> 
                                <span class="text-sm font-normal text-slate-500">
                                    (Usia <?php echo e($class->age_min); ?><?php echo e($class->age_max ? '-' . $class->age_max : '+'); ?> tahun)
                                </span>
                            </h2>
                            <p class="text-slate-500 text-sm mt-1"><?php echo e($class->description); ?></p>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <?php $__currentLoopData = $class->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkgIndex => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative bg-white rounded-3xl border border-slate-200/80 shadow-sm p-8 flex flex-col justify-between hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-left">
                                    <div>
                                        ...
                                        <h3 class="text-xl font-extrabold text-slate-850 mb-2"><?php echo e($package->name); ?></h3>
                                            ...
                                            <ul class="space-y-1.5">
                                                <?php $__currentLoopData = $package->locationPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="flex justify-between items-center text-xs font-semibold">
                                                        <span class="text-slate-500"><?php echo e($lp->location->name); ?></span>
                                                        <span class="text-slate-700 font-bold">Rp <?php echo e(number_format($lp->price, 0, ',', '.')); ?></span>
                                                    </li>
            ...
            <?php if($prestasiCat && $prestasiCat->swimmingClasses->isNotEmpty()): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                    <?php $__currentLoopData = $prestasiCat->swimmingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $class->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative bg-white rounded-3xl border border-slate-200/80 shadow-sm p-8 flex flex-col justify-between hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-left">
                                <div>
                                    <div class="flex justify-between items-start mb-6">
                                    ...
                                    <h3 class="text-2xl font-extrabold text-slate-800 mb-2"><?php echo e($class->name); ?></h3>
                                    <p class="text-slate-500 text-sm leading-relaxed mb-6"><?php echo e($class->description); ?></p>
                                    ...
                                    <div class="space-y-3 mb-8 border-t border-slate-100 pt-6">
                                        <div class="flex items-center justify-between text-xs font-semibold text-slate-650">
                                            ...
                                            <span class="font-bold text-slate-800">
                                                <?php echo e($class->age_min); ?><?php echo e($class->age_max ? '-' . $class->age_max : '+'); ?> Tahun
                                            </span>
                                        </div>
                                        <div class="flex items-center justify-between text-xs font-semibold text-slate-650">
                                            <span class="flex items-center gap-2">
                                            ...
                                            <span class="font-bold text-slate-800">
                                                <?php echo e($package->swim_sessions); ?>x per Bulan
                                            </span>
                                        </div>
                                        <div class="flex items-center justify-between text-xs font-semibold text-slate-650">
                                            <span class="flex items-center gap-2">
                                            ...
                                            <span class="font-bold text-slate-800">
                                                <?php echo e($package->dryland_sessions); ?>x per Bulan
                                            </span>
                                        </div>
                                        <div class="flex items-center justify-between text-xs font-semibold text-slate-650">
                                            <span class="flex items-center gap-2">
                                            ...
                                            <span class="font-bold text-red-500">
                                                Maksimal <?php echo e($class->max_quota); ?> Murid
                                            </span>
                                        </div>
                                    </div>
