...
<?php $component = App\View\Components\AppLayout::resolve(['title' => 'Parent - Menu Pembayaran'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'upload-receipt-'.e($student->id).'','focusable' => true]); ?>
                                            <form method="POST"
                                                action="<?php echo e(route('parent.payments.checkout', $student->id)); ?>"
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\klub-renang\resources\views/parent/payments/index.blade.php ENDPATH**/ ?>