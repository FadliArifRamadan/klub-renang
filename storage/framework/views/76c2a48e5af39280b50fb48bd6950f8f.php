<?php $__env->startSection('content'); ?>
    ...
    <section class="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <?php if($prestasiCategory && $prestasiCategory->swimmingClasses->isNotEmpty()): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <?php $__currentLoopData = $prestasiCategory->swimmingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.company-profile', ['title' => 'Kelas Renang Prestasi - Black Diamond Swimming Club'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\klub-renang\resources\views/company-profile/packages-prestasi.blade.php ENDPATH**/ ?>