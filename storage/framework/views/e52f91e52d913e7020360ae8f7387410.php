<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-20 md:pt-44 md:pb-32 bg-[#0B0F17] text-white overflow-hidden border-b border-[#D3AF37]/30">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-6 text-white">
                Kelas Belajar <span class="text-[#D3AF37]"><?php echo e($swimmingClass->name); ?></span>
            </h1>
            <p class="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-8 font-normal">
                Program latihan khusus untuk usia <?php echo e($swimmingClass->age_min); ?><?php echo e($swimmingClass->age_max ? '-' . $swimmingClass->age_max : '+'); ?> tahun dengan pilihan paket Reguler & Private.
            </p>
        </div>
    </section>
        ...
        <div>
            <div class="border-b border-slate-200 pb-4 mb-8 text-left">
                <h2 class="text-2xl font-extrabold text-slate-800 flex items-center gap-2">
                    ...
                    Tingkat <?php echo e($swimmingClass->name); ?> 
                    <span class="text-sm font-normal text-slate-500">
                        (Usia <?php echo e($swimmingClass->age_min); ?><?php echo e($swimmingClass->age_max ? '-' . $swimmingClass->age_max : '+'); ?> tahun)
                    </span>
                </h2>
                <p class="text-slate-500 text-sm mt-1"><?php echo e($swimmingClass->description); ?></p>
            </div>
            
            <?php if($swimmingClass->packages->isNotEmpty()): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $swimmingClass->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                <div class="flex justify-between items-start mb-6">
                                    ...
                                    <span class="text-xs text-slate-400 font-semibold">
                                        Masa Aktif: <?php echo e($package->active_period_months); ?> Bln
                                    </span>
                                </div>

                                <h3 class="text-xl font-extrabold text-slate-800 mb-2"><?php echo e($package->name); ?></h3>
                                <p class="text-slate-500 text-sm leading-relaxed mb-6">
                                    Program latihan <?php echo e($package->package_type === 'private' ? 'Private (1-on-1)' : 'Reguler (Kelompok)'); ?> 
                                    dengan <?php echo e($package->sessions); ?> sesi pertemuan selama <?php echo e($package->active_period_months); ?> bulan.
                                </p>
                                ...
                                <div class="bg-slate-50 rounded-2xl p-4 mb-6 border border-slate-100">
                                    ...
                                    <ul class="space-y-2">
                                        <?php $__currentLoopData = $package->locationPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <li class="flex justify-between items-center text-xs font-semibold">
                                                <span class="text-slate-600 flex items-center gap-1.5">
                                                    <span><?php echo e($lp->location->name); ?></span>
                                                    <?php if($isTicketIncluded): ?>
                                                ...
                                                <span class="text-slate-900 font-extrabold">Rp <?php echo e(number_format($lp->price, 0, ',', '.')); ?></span>
                                            </li>
            ...
            <?php else: ?>
                <div class="bg-white rounded-3xl p-16 text-center text-slate-400 border border-slate-200 shadow-sm">
                    ...
                    <p class="font-bold text-slate-500 text-lg mb-2">Paket <?php echo e($swimmingClass->name); ?> Belum Tersedia</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="py-16 my-16 md:my-24 max-w-7xl mx-4 sm:mx-6 lg:mx-auto bg-gradient-to-r from-[#0B0F17] via-[#1E1A0E] to-[#D3AF37] text-white text-center shadow-2xl rounded-3xl border border-[#D3AF37]/40 relative overflow-hidden">
        ...
        <div class="max-w-xl mx-auto px-4 py-6 sm:px-6 lg:px-8 relative z-10">
            <h2 class="text-2xl sm:text-3xl font-extrabold text-[#D3AF37] mb-3 tracking-tight">Ada Pertanyaan tentang Kelas <?php echo e($swimmingClass->name); ?>?</h2>
...
<?php echo $__env->make('layouts.company-profile', ['title' => 'Kelas Belajar Renang ' . $swimmingClass->name . ' - Black Diamond Swimming Club'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\klub-renang\resources\views/company-profile/packages-belajar-level.blade.php ENDPATH**/ ?>