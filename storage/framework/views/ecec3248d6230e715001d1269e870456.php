                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                    ...
                    <div class="flex flex-wrap items-center gap-1.5 bg-slate-50 p-1 rounded-2xl border border-slate-100 w-fit">
                        <a href="<?php echo e(route('admin.users.index', array_filter(['search' => $search]))); ?>" 
                           class="px-4 py-2 text-xs font-bold rounded-xl transition-all <?php echo e(empty($role) ? 'bg-white dark:bg-boxdark text-amber-600 dark:text-[#D3AF37] shadow-sm border border-slate-100' : 'text-slate-500 hover:text-slate-800'); ?>">
                            Semua
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.users.index', array_filter(['role' => 'coach', 'search' => $search]))); ?>" 
                           class="px-4 py-2 text-xs font-bold rounded-xl transition-all <?php echo e($role === 'coach' ? 'bg-sky-100 dark:bg-sky-900/40 text-sky-700 dark:text-sky-300 shadow-sm' : 'text-slate-500 hover:text-slate-800'); ?>">
                            Coach (Pelatih)
                        </a>
...
<?php endif; ?>
                        ...
                        <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-2 flex-nowrap whitespace-nowrap">
                            <?php if($role): ?>
                            ...
                            <a href="<?php echo e(route('admin.users.index', array_filter(['role' => $role]))); ?>" class="px-3.5 py-2 bg-slate-700 hover:bg-slate-600 text-white text-xs font-bold rounded-lg border border-slate-600 shadow-sm transition flex items-center gap-1.5 whitespace-nowrap cursor-pointer shrink-0">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white dark:bg-boxdark hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        ...
                                        <?php else: ?>
                                            <div class="w-10 h-10 rounded-full flex items-center justify-center mx-auto border-2 border-slate-150 shadow-sm
                                                <?php if($user->isAdmin()): ?> bg-amber-500/10 text-amber-600
                                                <?php elseif($user->role === 'coach'): ?> bg-blue-500/10 text-blue-600
                                                <?php elseif($user->role === 'parent'): ?> bg-emerald-500/10 text-emerald-600
                                                <?php else: ?> bg-slate-500/10 text-slate-600
                                                <?php endif; ?>">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if($user->role === 'admin_finance'): ?>
                                        ...
                                        <?php elseif($user->role === 'admin_operasional' || $user->role === 'admin'): ?>
...
<?php endif; ?>
                                                    ...
                                                    <div x-show="userRole === 'coach'" x-transition>
                                                        <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'gender-'.e($user->id).'','value' => 'Jenis Kelamin Pelatih','class' => 'font-bold text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'gender-'.e($user->id).'','value' => 'Jenis Kelamin Pelatih','class' => 'font-bold text-xs']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php unset($__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581); ?>
<?php endif; ?>
                                                        <select id="gender-<?php echo e($user->id); ?>" name="gender"
                                                            ...
                                                            <option value="" <?php echo e(old('gender', $user->gender) == '' ? 'selected' : ''); ?>>-- Pilih Jenis Kelamin --</option>
                                                            <option value="L" <?php echo e(old('gender', $user->gender) == 'L' ? 'selected' : ''); ?>>Laki-laki (Male)</option>
                                                            <option value="P" <?php echo e(old('gender', $user->gender) == 'P' ? 'selected' : ''); ?>>Perempuan (Female)</option>
                                                        </select>
                                                    </div>
...
<?php endif; ?>
                                                    ...
                                                    <div x-show="userRole === 'coach'" x-transition class="mt-4 p-4 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-xl space-y-4 shadow-sm">
                                                        ...
                                                        ?>
                                                        <div x-data="{
                                                            items: <?php echo e(Js::from($editLicenses)); ?>,
                                                            counter: <?php echo e(count($editLicenses)); ?>,
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="experience" value="<?php echo e($user->experience); ?>" class="w-full text-sm border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:border-blue-500 focus:ring-blue-500" placeholder="Contoh: Aktif melatih sejak 2021 di Black Diamond">
                                                        </div>
                                                    </div>
...
<?php endif; ?>
                ...
                <div x-show="userRole === 'coach'" x-transition>
                    <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'create-gender','value' => 'Jenis Kelamin Pelatih','class' => 'font-bold text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'create-gender','value' => 'Jenis Kelamin Pelatih','class' => 'font-bold text-xs']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
                    <select id="create-gender" name="gender"
                        ...
                        <option value="L" <?php echo e(old('gender') == 'L' ? 'selected' : ''); ?>>Laki-laki (Male)</option>
                        <option value="P" <?php echo e(old('gender') == 'P' ? 'selected' : ''); ?>>Perempuan (Female)</option>
                    </select>
                </div>
