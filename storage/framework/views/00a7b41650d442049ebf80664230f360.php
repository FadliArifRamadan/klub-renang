        ...
        <div>
            <div class="flex justify-between items-center mb-1.5">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-xs font-semibold text-blue-600 hover:text-blue-700 hover:underline" href="<?php echo e(route('password.request')); ?>">
                        Lupa Password?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
    ...
    <div class="mt-6 pt-5 border-t border-slate-100 text-center">
        <p class="text-xs text-slate-500">
            Belum memiliki akun?
            <a href="<?php echo e(route('register')); ?>" class="font-bold text-blue-600 hover:text-blue-700 hover:underline">
                Daftar Sekarang
            </a>
        </p>
    </div>
