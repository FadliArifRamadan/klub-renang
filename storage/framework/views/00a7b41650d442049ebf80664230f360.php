        ...
        <div>
            <div class="flex justify-between items-center mb-1.5">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-xs font-semibold text-[#D3AF37] hover:text-[#B89426] hover:underline" href="<?php echo e(route('password.request')); ?>">
                        Lupa Password?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
    ...
    <div class="mt-6 pt-5 border-t border-slate-800 text-center">
        <p class="text-xs text-slate-400">
            Belum memiliki akun?
            <a href="<?php echo e(route('register')); ?>" class="font-bold text-[#D3AF37] hover:text-[#B89426] hover:underline">
                Daftar Sekarang
            </a>
        </p>
    </div>
