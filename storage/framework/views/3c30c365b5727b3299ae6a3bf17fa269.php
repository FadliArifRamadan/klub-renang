<?php $__env->startSection('content'); ?>
    ...
    <section x-data="{ 
        ...
        <?php if($founders->isNotEmpty()): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-<?php echo e($founders->count() >= 4 ? '4' : $founders->count()); ?> gap-8 <?php echo e($founders->count() < 4 ? 'max-w-4xl mx-auto' : ''); ?>">
                <?php $__currentLoopData = $founders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $founder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div @click="openModal({
                            name: '<?php echo e(addslashes($founder->name)); ?>',
                            position: '<?php echo e(addslashes($founder->position)); ?>',
                            image: '<?php echo e($founder->image ? asset('storage/' . $founder->image) : ''); ?>',
                            bio: <?php echo e(Js::from($founder->bio ?? 'Belum ada informasi bio.')); ?>,
                            social_media: <?php echo e(Js::from($founder->social_media ?? [])); ?>
                        ...
                        <div class="relative h-72 bg-slate-100 overflow-hidden">
                            <?php if($founder->image): ?>
                                <img src="<?php echo e(asset('storage/' . $founder->image)); ?>" alt="Foto <?php echo e($founder->name); ?>"
                        ...
                        <div class="p-6 text-left">
                            <h3 class="font-extrabold text-slate-800 text-base mb-1 truncate"><?php echo e($founder->name); ?></h3>
                            <p class="text-xs text-[#D3AF37] font-bold uppercase tracking-wider mb-2"><?php echo e($founder->position); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.company-profile', ['title' => 'Founders - Black Diamond Swimming Club'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\klub-renang\resources\views/company-profile/about-founders.blade.php ENDPATH**/ ?>