    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $isLocationBased) {
            $package = Package::create([
                ...
                'swim_sessions' => $request->package_type === 'monthly_prestasi' ? ($request->swim_sessions ?? $request->sessions) : $request->sessions,
                'dryland_sessions' => $request->package_type === 'monthly_prestasi' ? ($request->dryland_sessions ?? 0) : 0,
