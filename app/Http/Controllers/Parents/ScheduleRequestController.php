...
{
    /**
     * Simpan pengajuan pindah jadwal baru (dari Parent)
     */
    public function store(Request $request, Student $student)
    {
        ...
        if ($exists) {
            return redirect()->back()->with('error', 'Murid ini sudah memiliki pengajuan pindah jadwal yang sedang ditinjau.');
        }
        ...
        return redirect()->route('parent.dashboard')->with('success', 'Pengajuan pindah jadwal berhasil dikirim! Menunggu persetujuan Admin.');
    }
}
